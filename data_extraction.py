...
def process_files_parallel(files, folder_path, output_file):
    vocab = set()
...
vocab_train = process_files_parallel(files_train_sampled, folder_path, output_file_train)

# Process the sampled validation files
vocab_val = process_files_parallel(files_val_sampled, folder_path, output_file_val)
